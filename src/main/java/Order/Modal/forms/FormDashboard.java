...
import Order.Modal.component.Chart.renderer.other.ChartCandlestickRenderer;
import Order.Modal.component.Chart.utils.ToolBarCategoryOrientation;
import Order.Modal.component.Chart.utils.ToolBarTimeSeriesChartRenderer;
import Order.Modal.component.ToolBarSelection;
import Order.Modal.component.dashboard.CardBox;
...
//        class file contains wrong class
    ...
    private void createCard() {
        ...
        cardBox = new CardBox();
        cardBox.addCardItem(createIcon("Order/icons/dashboard/customer.svg", DefaultChartTheme.getColor(0)), "Total Customer");
        cardBox.addCardItem(createIcon("Order/icons/dashboard/income.svg", DefaultChartTheme.getColor(1)), "Total Income");
        cardBox.addCardItem(createIcon("Order/icons/dashboard/expense.svg", DefaultChartTheme.getColor(2)), "Total Expense");
        cardBox.addCardItem(createIcon("Order/icons/dashboard/profit.svg", DefaultChartTheme.getColor(3)), "Last Profit");
        panel.add(cardBox);
