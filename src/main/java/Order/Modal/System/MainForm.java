...
import Order.Modal.component.FormSearchButton;
import Order.Modal.component.MemoryBar;
import Order.Modal.component.RefreshLine;
...
public class MainForm extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        JButton buttonDrawer = new JButton(new FlatSVGIcon("Order/icons/menu.svg", 0.5f));
        buttonUndo = new JButton(new FlatSVGIcon("Order/icons/undo.svg", 0.5f));
        buttonRedo = new JButton(new FlatSVGIcon("Order/icons/redo.svg", 0.5f));
        buttonRefresh = new JButton(new FlatSVGIcon("Order/icons/refresh.svg", 0.5f));
...
//        buttonRefresh.addActionListener(e -> FormManager.refresh());
    ...
    private JPanel createFooter() {
        ...
        // demo version
        JLabel lbDemoVersion = new JLabel("Demo: v" + OrderMain.DEMO_VERSION);
        lbDemoVersion.putClientProperty(FlatClientProperties.STYLE, "" +
                "foreground:$Label.disabledForeground;");
        lbDemoVersion.setIcon(new SVGIconUIColor("Order/icons/git.svg", 1f, "Label.disabledForeground"));
        ...
        lbJava.putClientProperty(FlatClientProperties.STYLE, "" +
                "foreground:$Label.disabledForeground;");
        lbJava.setIcon(new SVGIconUIColor("Order/icons/java.svg", 1f, "Label.disabledForeground"));
        panel.add(lbJava);
